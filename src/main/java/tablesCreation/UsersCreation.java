...
public class UsersCreation {
        ...
        try (Connection connection = DriverManager.getConnection(URL, USERNAME, PASSWORD);
            ...
            String createUsersTable =
                    "CREATE TABLE IF NOT EXISTS Users ("
                            ...
                            + "role VARCHAR(20) NOT NULL" // Modificați tipul câmpului isAdministrator
                            + ")";
    ...
    public static void insertUserData() {
        ...
        try (Connection connection = DriverManager.getConnection(URL, USERNAME, PASSWORD)) {
            ...
            System.err.println(
                    "Error connecting to or querying the database: " + e.getMessage());
        }
    }
    ...
    public static List<User> getAllUsers() {
        ...
        try (Connection connection = DriverManager.getConnection(URL, USERNAME, PASSWORD);
            ...
            while (resultSet.next()) {
                ...
                Roles role = Roles.valueOf(resultSet.getString("role")); // Get the role from the database
